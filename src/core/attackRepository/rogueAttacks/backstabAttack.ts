...
export class backstabAttack extends Attack {
    ...
    constructor(affector?: AffectsWeight) {
        ...
        this.manaCost = 0;
        this.range = 1;
        this.coreDescription = 'When you hit, deal damage. Double this damage if an enemy was not aware of you, was stunned, or is adjacent to your ally and did not attack you last turn';
        this.subtype = Attack.Subtype.Spell;
        this.initModifiers();
        this.modifiers.push(new compensationModifier('Backstab', 0.75, 0))
        this.initDamage();
        this.compensate();
    }
}