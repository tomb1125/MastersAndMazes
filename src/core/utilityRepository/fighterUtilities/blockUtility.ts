...
export class blockUtility extends Utility {
    ...
    constructor() {
        ...
        this.compensate();
        this.description = 'Use as reaction when being attacked. If you succeed you reduce damage by '+this.value.getDescription()+'. You gain 2 Boons for chance roll if you use a shield otherwise you gain 1 Boon for your next Attack against source of the attack. ';
