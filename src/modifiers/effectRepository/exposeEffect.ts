...
export class exposeEffect extends Effect {
    ...
    constructor() {
        ...
        this.description = 'Exposed - when rolling for an ability targeting this creature, any attacker gains '+this.value+' Boon. This effect lasts until end of your next turn. ';
